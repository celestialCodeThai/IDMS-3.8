...
namespace IDMS.ReportContent
{
    class PdfEGD_TemplateB
    {
        ...
        private PdfPTable GetHeader(Document pdfDoc, PdfWriter writer, String PRO, Page.Report report)
        {
            ...
            PlaceChunckHead(writer, "Esophagogastroduodenoscopy Report", 90, 820);
            //load setting logo ชื่อโรงบาล
        ...
        private PdfPTable GetBodyEGD(Document pdfDoc, PdfWriter writer, Report report, reportControlEGD reportControl, imageReport output, string ORIGINAL_ID)
        {
            ...
            string financeNamce = load.getValueWithTableName(ORIGINAL_ID, "patientcase", "finance");
            ...
            F04 = new Phrase("     Cardia:", subLabel);
            F05 = new Phrase("   Fundus:", subLabel);
            F06 = new Phrase("       Body:", subLabel);
            F07 = new Phrase("   Antrum:", subLabel);
            F08 = new Phrase("   Pylorus:", subLabel);
            ...
            */
            ...
            if (reportControl.pg32.Checked == true) { if (ptxt2 != "") { ptxt2 += ", "; } ptxt2 += reportControl.pg32.Text; }
            if (reportControl.pg33.Checked == true) { if (ptxt2 != "") { ptxt2 += ", "; } ptxt2 += reportControl.pg33.Text; }
            if (reportControl.pg34.Checked == true) { if (ptxt2 != "") { ptxt2 += ", "; } ptxt2 += reportControl.pg34.Text; }
            ...
            lb1_1.SetSimpleColumn(LB1_1, BodyX, lb1y - 500, 580, lb1y, 15, Element.ALIGN_LEFT); lb1_1.Go();
            l1_1.SetSimpleColumn(getL1_1, BodyX + 65, lb1y - 500, 580, lb1y, 15, Element.ALIGN_LEFT); l1_1.Go();
            ...
            lb8.SetSimpleColumn(LB8, BodyX + LowerSpace, lb4y - 500, 580, lb4y, 15, Element.ALIGN_LEFT); lb8.Go();
            l8.SetSimpleColumn(getL8, BodyX + LowerSpace + 90, lb4y - 500, 580, lb4y, 15, Element.ALIGN_LEFT); l8.Go();
        ...
        private PdfPTable GetImg2_2(Document pdfDoc, PdfWriter writer, int page, imageReport output, Report report)
        {
            ...
            /*
            int page = 0;
            int pivot = 4;//4 = capacity of page 1
            int image_per_page = 12;
            while(i>pivot)
            {
                if (i > pivot) page++; 
                pivot += image_per_page;
