...
namespace IDMS.ReportContent
{
    class PdfENT
    {
        ...
        public void GenPDF(String PRO, imageReport output, Report report, reportControlENT ERCP, string ORIGINAL_ID, bool Multimode)
        {
            ...
            pdfDoc.Add(GetBodyENT(pdfDoc, writer, report, ERCP, output));
        ...
        private PdfPTable GetBodyENT(Document pdfDoc, PdfWriter writer, Report report, reportControlENT reportControl, imageReport output)
        {
