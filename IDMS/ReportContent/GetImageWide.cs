...
namespace IDMS.ReportContent
{
    class GetImageWide
    {
        ...
        public PdfPTable FirstPage_2(Document pdfDoc, PdfWriter writer, imageReport output, string doctorName, string procedure)
        {
            ...
            int imgperpage;
            if (i < 3) { imgperpage = i; } else { imgperpage = 3; }
            LoopX = paddingLeft; LoopY = LoopY - imageHeight - 20;
            for (int z = 0; z < imgperpage; z++)
            {
                Image img = Image.FromFile(output.imgPath[z]);
        ...
        public PdfPTable MultiPage_2(Document pdfDoc, PdfWriter writer, int page, imageReport output, string doctorName, string procedure)
        {
            ...
            P5 = new string[] { "AB", "AC", "AD", "AE", "AF", "AG", "AH", "AI" };
