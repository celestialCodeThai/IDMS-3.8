...
namespace IDMS.ReportContent
{
    public partial class output : UserControl
    {
        ...
        public output()
        {
            ...
            if (c.pg26.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg26.Text; }
            if (c.pg27.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg27.Text; }
            if (c.pg28.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg28.Text; }
            if (c.pg29.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg29.Text; }
            if (c.pg30.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg30.Text; }
            if (c.pg31.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pgtxtbox2.Text; }
            if (c.pg32.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg32.Text; }
            if (c.pg33.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg33.Text; }
            if (c.pg34.Checked == true) { if (ptxt != "") { ptxt += ", "; } ptxt += c.pg34.Text; }
            ...
            for (int e = 0; e < b.imgCount; e++)
            {
                if (b.imgPath[i] != null)
                {
                    if (b.imgPath[i].Contains("EGD") == true)
                    {
                        i++;
                    }
                }
        ...
        private void mt7_TextChanged(object sender, EventArgs e)
        {
