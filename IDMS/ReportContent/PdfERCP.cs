...
namespace IDMS.ReportContent
{
    class PdfERCP
    {
        ...
        public PdfERCP(imageReport output)
        {
        ...
        //reportBody
        private PdfPTable GetBodyERCP(Document pdfDoc, PdfWriter writer, Report report, reportControlERCP reportControl, imageReport output)
        {
        ...
        private PdfPTable GetHeader(Document pdfDoc, PdfWriter writer, String PRO, Page.Report report)
        {
            ...
            PlaceChunckHead(writer, "ERCP Report", 110, 820);
            DataManage.DataAccess Load = new DataManage.DataAccess();
