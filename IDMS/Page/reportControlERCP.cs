...
namespace IDMS.Page
{
    public partial class reportControlERCP : UserControl
    {
        public reportControlERCP(string caseid)
        {
            InitializeComponent();
        ...
        private void f10list_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void CreportControl_Load(object sender, EventArgs e)
        {
        ...
        private void pg1_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void pg24_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void his3_CheckedChanged(object sender, EventArgs e)
        {
            if (his3.Checked)
            {
                his3txt.Visible = true;
        ...
        private void pg7_CheckedChanged(object sender, EventArgs e)
        {
            if (pg7.Checked)
            {
                pg6.Checked = true;
        ...
        private void pg8_CheckedChanged(object sender, EventArgs e)
        {
            if (pg8.Checked)
            {
                pg6.Checked = true;
        ...
        private void pg6_CheckedChanged(object sender, EventArgs e)
        {
            if (pg6.Checked== false)
            {
                pg7.Checked = false;
                pg8.Checked = false;
        ...
        private void pg9_CheckedChanged(object sender, EventArgs e)
        {

            if (pg9.Checked == false)
            {
                pg10.Checked = false;
                pg11.Checked = false;
        ...
        private void pg10_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void pg11_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void pg12_CheckedChanged(object sender, EventArgs e)
        {

            if (pg12.Checked == false)
            {
                pg13.Checked = false;
                pg14.Checked = false;
                pg15.Checked = false;
        ...
        private void pg14_CheckedChanged(object sender, EventArgs e)
        {
            if (pg14.Checked)
            {
                pg13.Checked = true;             
        ...
        private void pg15_CheckedChanged(object sender, EventArgs e)
        {
            if (pg15.Checked)
            {
                pg13.Checked = true;
        ...
        private void pg16_CheckedChanged(object sender, EventArgs e)
        {
            if (pg16.Checked)
            {
                pg12.Checked = true;
