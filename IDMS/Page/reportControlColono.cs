...
namespace IDMS.Page
{
    public partial class reportControlColono : UserControl
    {
        public reportControlColono(string caseid)
        {
            InitializeComponent();
        ...
        private void f9txt_TextChanged(object sender, EventArgs e)
        {
        ...
        private void bowelPreparationRegimen_SelectedIndexChanged(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("bowelPreparationRegimen is " + bowelPreparationRegimen.Text);
            bowelPreparationRegimenValue.Text = bowelPreparationRegimen.Text;
        }

        private void bowelPreparationResult_SelectedIndexChanged(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("bowelPreparationResult is " + bowelPreparationResult.Text);
            bowelPreparationResultValue.Text = bowelPreparationResult.Text;
        }
    }
}
